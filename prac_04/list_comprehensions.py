...
# DO: list comprehension to create a list of all the full_names in lowercase format
# lowercase_full_names =

almost_numbers = ['0', '10', '21', '3', '-7', '88', '9']
# DO: list comprehension to create a list of integers from the above list of strings
# numbers =

# DO: list comprehension to create a list of only the numbers that are
# greater than 9 from the numbers (not strings) you just created

# DO: (more advanced) use a list comprehension and the join string method
